...
- If the app reports it's "damaged", re-download from the
  ...
  [verify the checksum](./installation.md#verifying-your-download).
...
which live encrypted in the [OS keychain](./connecting.md#how-your-credentials-are-stored))

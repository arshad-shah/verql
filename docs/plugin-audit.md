...
in [src/main/plugins/types.ts](../src/main/plugins/types.ts#L37).

**Runtime:** **no registry**. Themes are hardcoded as CSS files under
[src/renderer/src/primitives/theme/themes/](../src/renderer/src/primitives/theme/themes/),
imported into [globals.css](../src/renderer/src/styles/globals.css),
and the available-themes list lives in [@shared/settings](../shared/settings.ts).
...
[lib/monaco-themes.ts](../src/renderer/src/lib/monaco-themes.ts).

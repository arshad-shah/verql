# Notifications & the attention seam
...
See also: [plugins.md §13](./plugins.md#13-desktop-notifications--the-attention-seam)
for the consumer-facing API, and [architecture.md](./architecture.md#main-process)

...
| [plugins.md](./plugins.md) | What a plugin is, every contribution surface (driver, exporter, importer, type mapper, theme, panel, command, AI provider, settings, …), and how to write one. Read this if you're adding a new database type. |

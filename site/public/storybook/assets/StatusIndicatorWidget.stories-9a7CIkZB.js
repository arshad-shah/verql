...
}`,...r.parameters?.docs?.source},description:{story:"Healthy / connected — green dot.",...r.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      label: 'Replica lag',
      status: 'warning'
...
}`,...t.parameters?.docs?.source},description:{story:"Warning — amber dot.",...t.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      label: 'Disconnected',
      status: 'error'
...
}`,...o.parameters?.docs?.source},description:{story:"Error — red dot.",...o.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      label: 'Connecting…',
      status: 'loading'
...
}`,...i.parameters?.docs?.source},description:{story:"Loading — pulsing accent dot.",...i.parameters?.docs?.description}}};const Qr=["Ok","Warning","Error","Loading"];export{o as Error,i as Loading,r as Ok,t as Warning,Qr as __namedExportsOrder,Nr as default};

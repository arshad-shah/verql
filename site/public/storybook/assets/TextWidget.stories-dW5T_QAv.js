...
}`,...t.parameters?.docs?.source},description:{story:"Default `value` style — primary text color.",...t.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      content: 'Schema',
      style: 'label'
...
}`,...r.parameters?.docs?.source},description:{story:"`label` style — muted, uppercase, tracked. Used for field captions.",...r.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      content: '1,204 rows',
      style: 'muted'
...
}`,...o.parameters?.docs?.source},description:{story:"`muted` style — disabled color for secondary detail.",...o.parameters?.docs?.description}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      content: 'never shown',
      visible: false
...
}`,...e.parameters?.docs?.source},description:{story:"A hidden widget renders nothing.",...e.parameters?.docs?.description}}};const Kt=["Value","Label","Muted","Hidden"];export{e as Hidden,r as Label,o as Muted,t as Value,Kt as __namedExportsOrder,Jt as default};

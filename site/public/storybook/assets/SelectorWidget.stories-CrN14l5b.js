...
}`,...o.parameters?.docs?.source},description:{story:"Static options with a preselected value.",...o.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      options: dbOptions
    })
  }
}`,...t.parameters?.docs?.source},description:{story:"No value set — Select shows its placeholder / first state.",...t.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    widget: base({
      label: 'Collection',
      options: Array.from({
...
}`,...r.parameters?.docs?.source},description:{story:"Searchable selector for longer option lists.",...r.parameters?.docs?.description}}};const it=["WithOptions","NoSelection","Searchable"];export{t as NoSelection,r as Searchable,o as WithOptions,it as __namedExportsOrder,rt as default};

...
}`,...o.parameters?.docs?.source},description:{story:"One plugin failed to load — warning dot + count.",...o.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  decorators: [Story => {
    stubPlugins([...active(3), {
      status: {
        state: 'activating'
      }
    }]);
...
}`,...i.parameters?.docs?.source},description:{story:"Plugins still in a transitional state — shows the loading spinner.",...i.parameters?.docs?.description}}};const Zt=["AllActive","WithFailures","Loading"];export{r as AllActive,i as Loading,o as WithFailures,Zt as __namedExportsOrder,Yt as default};

...
description: Creating connection profiles, supported databases, SSH tunnels, and how Verql keeps your credentials safe.
sidebar:
  order: 2
---
...
loads into the browser (see [Exploring your schema](/guide/exploring-schema/)) and
...
Next: [Running queries →](/guide/querying/)

...
description: Verql's incremental restore-on-startup engine for open query tabs — a pure projection + diff core, a debounced coalescing engine, and the SQLite app-data store (open_tabs) reached over IPC.
sidebar:
  order: 9
---
...
now the main-process SQLite [app-data store](/develop/architecture/) (`open_tabs`

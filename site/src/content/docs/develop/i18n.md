...
description: Verql's homegrown, dependency-free, cross-process message catalogue — the typed t() / MessageKey, the React layer, key naming, interpolation/plurals, and locale registration.
sidebar:
  order: 7
---
